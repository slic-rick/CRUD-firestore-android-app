...
public class HealthAndAppliedScienceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       View v = inflater.inflate(R.layout.health_and_applied_fragment, container, false);
        recyclerView = (RecyclerView) v.findViewById(R.id.health_and_applied_recyclerview);
