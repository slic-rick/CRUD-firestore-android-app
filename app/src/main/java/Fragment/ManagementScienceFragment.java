...
public class ManagementScienceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.management_science_fragment, container, false);

        recyclerView = (RecyclerView) v.findViewById(R.id.management_science_recyclerview);
